...
import classes
from classes import Weather, Playlist, Location, WeatherMoodBuilder, WeatherMoodLibrary, WeatherMoodErrors
...
class TestWeatherMood_Library(TestCase):
    ...
    def test_display_all(self):
        ...
        all_weatherMoods = library.list_all_playlists()

        for item in all_weatherMoods:
            print(item)
        self.clear_database()
